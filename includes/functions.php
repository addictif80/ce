...
function getDefaultMenuItems() {
    return [
        ...
        ['item_key' => 'outils', 'parent_key' => null, 'label' => 'Outils', 'icon' => 'fa-tools', 'url' => null, 'uri_patterns' => 'credit_immo,calculateur,courriers,blocnotes,procedures,bureau_dom', 'ordre' => 4],
