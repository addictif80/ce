...
<body>
    ...
    <div class="sidebar" id="sidebar">
        ...
        <nav class="sidebar-nav">
            <a href="index.php" class="<?= $currentPage === 'index' ? 'active' : '' ?>"><i class="fas fa-home"></i> Accueil</a>

            <div class="nav-section">Mon activité</div>
            <a href="modules/instances/index.php" class="<?= strpos($_SERVER['REQUEST_URI'], 'instances') !== false ? 'active' : '' ?>"><i class="fas fa-tasks"></i> Mes instances</a>
            ...
            <a href="modules/phoning/index.php" class="<?= strpos($_SERVER['REQUEST_URI'], 'phoning') !== false ? 'active' : '' ?>"><i class="fas fa-phone-volume"></i> Séances phoning</a>
            <a href="modules/eai/index.php" class="<?= strpos($_SERVER['REQUEST_URI'], 'eai') !== false ? 'active' : '' ?>"><i class="fas fa-bullseye"></i> EAI</a>

            <div class="nav-section">Outils</div>
            <a href="modules/credit_immo/index.php" class="<?= strpos($_SERVER['REQUEST_URI'], 'credit_immo') !== false ? 'active' : '' ?>"><i class="fas fa-house-chimney"></i> Crédit immobilier</a>
            <a href="modules/calculateur/index.php" class="<?= strpos($_SERVER['REQUEST_URI'], 'calculateur') !== false ? 'active' : '' ?>"><i class="fas fa-calculator"></i> Calculateur budget</a>
            <a href="modules/courriers/index.php" class="<?= strpos($_SERVER['REQUEST_URI'], 'courriers') !== false ? 'active' : '' ?>"><i class="fas fa-envelope"></i> Générateur courriers</a>
            <a href="modules/blocnotes/index.php" class="<?= strpos($_SERVER['REQUEST_URI'], 'blocnotes') !== false ? 'active' : '' ?>"><i class="fas fa-sticky-note"></i> Bloc-notes</a>
            <a href="modules/procedures/index.php" class="<?= strpos($_SERVER['REQUEST_URI'], 'procedures') !== false ? 'active' : '' ?>"><i class="fas fa-book"></i> Procédures</a>

            <div class="nav-section">Références</div>
            <a href="modules/codes/index.php" class="<?= strpos($_SERVER['REQUEST_URI'], '/codes/') !== false ? 'active' : '' ?>"><i class="fas fa-key"></i> Codes utiles</a>
            <a href="modules/contacts/index.php" class="<?= strpos($_SERVER['REQUEST_URI'], '/contacts/') !== false ? 'active' : '' ?>"><i class="fas fa-address-book"></i> Contacts utiles</a>
            ...
            <?php if (isAdmin()): ?>
                <a href="modules/admin/index.php" class="<?= strpos($_SERVER['REQUEST_URI'], 'admin') !== false ? 'active' : '' ?>"><i class="fas fa-cog"></i> Administration</a>
            <?php endif; ?>
            <a href="modules/profil/index.php" class="<?= strpos($_SERVER['REQUEST_URI'], 'profil') !== false ? 'active' : '' ?>"><i class="fas fa-user"></i> Mon profil</a>
